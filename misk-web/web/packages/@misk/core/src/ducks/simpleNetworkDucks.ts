...
export const dispatch: IDispatchSimpleNetwork = {
  simpleNetworkDelete: (
...
export const dispatchSimpleNetwork = dispatch
...
function* handleBasicRequest(
  ...
  try {
    ...
    yield put(
      dispatch.simpleNetworkSuccess({ tags: { [tag]: { data: { ...data } } } })
    )
  } catch (e) {
    const { tag } = action.payload
    yield put(
      dispatch.simpleNetworkFailure({ tags: { [tag]: { error: { ...e } } } })
    )
  }
}
